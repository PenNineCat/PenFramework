// File /UnitTest/OutputInterface/ConsoleInterface.h
...
namespace PenFramework::UnitTest
{
	...
	public:
		...
		SpdlogSTSharedHandle(SpdlogSTSharedHandle&&) noexcept = default;
		SpdlogSTSharedHandle& operator=(const SpdlogSTSharedHandle&) = default;
		SpdlogSTSharedHandle& operator=(SpdlogSTSharedHandle&&) noexcept = default;
